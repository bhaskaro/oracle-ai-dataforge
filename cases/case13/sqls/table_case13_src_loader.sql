-- ============================================================
-- Script: table_case13_src_loader.sql
-- Purpose:
--   - Ensure TABLE_CASE13_SRC exists (create if needed)
...
---------------------------------------------------------------
-- 1. Create TABLE_CASE13_SRC if it does not exist
---------------------------------------------------------------
DECLARE
...
/
---------------------------------------------------------------
-- 2. Populate / top-up TABLE_CASE13_SRC to p_target_rows
---------------------------------------------------------------
DECLARE
...
BEGIN
  ...
  IF v_to_insert > 0 THEN
    -- Current max COL1 (for uniqueness)
    ...
    FOR i IN 1 .. v_to_insert LOOP
      ...
      SELECT
        ...
        DBMS_RANDOM.STRING('U',204), -- COL10 (80% of 255)
